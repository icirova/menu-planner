...
export const IngredientInputs = forwardRef(
  ({ ingredients, setIngredients, onValidationError }, ref) => {
    ...
    const getDraftValidation = useCallback(() => {
    ...
    const reportDraftError = useCallback(
      ...
      [focusDraftField, onValidationError],
    );
    ...
    useImperativeHandle(
      ...
      [focusDraftField, getDraftValidation, reportDraftError, setIngredients],
    );
              ...
              <ul className="ingredient-list" role="list" aria-live="polite">
                {ingredients.map((ing, i) => (
                  <li key={i} className="ingredient-item">
                    <span className="ingredient-text">{formatIngredient(ing, 1, 1)}</span>
                    <button
                      type="button"
