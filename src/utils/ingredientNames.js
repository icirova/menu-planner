...
const INGREDIENT_NAME_GROUPS = [
  ...
  {
    canonical: "rostlinný olej",
    aliases: ["rostlinného oleje"],
    measuredName: "rostlinného oleje",
  },
  ...
  { canonical: "čerstvé droždí", aliases: ["čerstvého droždí"], measuredName: "čerstvého droždí" },
  {
    ...
    aliases: ["prášku do pečiva"],
    measuredName: "prášku do pečiva",
  },
  {
    canonical: "prášek do pečení",
    aliases: ["prášku do pečení"],
    measuredName: "prášku do pečení",
  },
  {
